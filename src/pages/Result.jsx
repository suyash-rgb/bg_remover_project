...
const Result = () => {
    ...
    return (
        <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[75wh]">
            ...
            <div className="bg-white rounded-lg ox-8 py-6 shadow-md">
                {/*image container */}
            ...
            {resultImage && (
                <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
                    ...
                    <a href={resultImage} download className="cursor-pointer py-3 px-6 text-center text-white font-semibold rounded-full bg-gradient-to-r from purple-500 to indigo-500 shadow-lg hoven:from-purple-600 hover:to-indigo-600 transition duration-300 ease-in-out transform hover:scale-105">
                        Download Image
                    </a>
                </div>
            )}
