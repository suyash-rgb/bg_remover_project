        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-1 md:order-2">
                ...
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                    Transform your photos with out background remover app! Highlight your subject and create a transparent background, so you can place it in a variety of new designs and destinations. Try it now and immerse your subject in a completely different enviroment!
                </p>

                <div>
                    <input type="file" accept="image/*" id="upload1" hidden onChange={(e) => removeBg(e.target.files[0])} />
                    <label htmlFor="upload1"
                        className="bg-black text-white font-medium px-8 py-4 rounded-full hover:opacity-90 transition-transform hover:scale-105 text-large">
                        Upload your image
                    </label>
