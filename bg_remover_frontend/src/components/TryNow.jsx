...
const TryNow = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-white px-4 w-full max-w-5xl">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-10 flex flex-col items-center space-y-4 w-full max-w-4xl">
