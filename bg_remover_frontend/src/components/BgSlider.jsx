...
const BgSlider = () => {
  ...
  return (
    <div className="mb-16 relative">
        {/* Section title */}
        <h2 className="text-3xl md:text-size-4xl font-bold text-gray-900 mb-12 text-center">
            Stunning Quality
        </h2>
        ...
        <div className="relative w-full max-w-4xl overflow-hidden m-auto rounded-xl shadow-lg">
            <img src={assets.with_bg} 
            alt="original image" 
            style={{clipPath: `inset(0 ${100.2-sliderPosition}% 0 0)`}}></img>

            <img src={assets.without_bg} 
            alt="background removed image" 
            style={{clipPath: `inset(0 0 0 ${sliderPosition}%)`}} 
            className="absolute top-0 left-0 w-full h-full"></img>
